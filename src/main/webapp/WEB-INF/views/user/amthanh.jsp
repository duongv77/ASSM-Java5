...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-3">
                <div class="nav">
                    <ul>
                        <li>
                            <a id="phone" class="row" href="${ pageContext.request.contextPath }/home/giohang/">
        ...
        <div class="produc-sale">
            <h2 class="color-red"><img class="icon-set-sale" width="25px" src="/css/img/icon-set.gif" alt=""> ÂM THANH</h2>
    
            <div class="row-custom">
                <c:forEach items="${ amthanhPro }" var="dtpro">
